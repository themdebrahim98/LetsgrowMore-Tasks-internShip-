...
export default function StudentProfile({ username,adminChange}) {
  ...
  const submitDataToDb = async () => {
    ...
    const url = 'http://localhost:5000/api/studentprofileupdate';
  ...
  useEffect(async () => {
    const url = "http://localhost:5000/api/studentprofile";
                ...
                <div>
                  <form action="" >
                    ...
                    <div className="data">
                      ...
                      <input disabled={isDisabled} required={true} value={elm.uuid === currentEditId.currentId ? currentEditData.year : elm.year} onChange={handlechange} type="text" name="year" id="year" />
                    </div>
                    <div className="data">
                      <label htmlFor="dept">dept</label>
                      <input disabled={isDisabled} required={true} value={elm.uuid === currentEditId.currentId ? currentEditData.dept : elm.dept} onChange={handlechange} type="text" name="dept" id="dept" />
                    </div>
                  ...
                  <button><Link to='/' style={{textDecoration:"none"}}>Log out</Link></button>
